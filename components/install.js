    ...
    return new Promise((resolve, reject) => {
        yauzl.open(file, { lazyEntries: true }, (err, zipFile) => {
            ...
            zipFile.on("entry", (entry) => {
                ...
                const entryPath = path.join(dir, 'jre', newFileName);
 ...
 *   })
 */
function install(dir, version = 8, options = {}) {
    try {
        const {
...
install(`C:\\Users\\N1TAXE\\AppData\\Roaming\\.gplauncher`)